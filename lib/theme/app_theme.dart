...
class AppTheme {
  // 主色配色
  static const Color primaryColor = Color(0xFF1E2A38); // 星空色
  static const Color accentColor = Color(0xFF6C5CE7); // 紫光渐变起始
  static const Color accentColorEnd = Color(0xFFA29BFE); // 紫光渐变结束
  static const Color backgroundColor = Color(0xFFF9F9F9); // 象牙色
  static const Color cardBackground = Color(0xFFF7F8FA); // 微米色
